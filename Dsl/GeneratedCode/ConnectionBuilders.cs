...
namespace Company.CyberPhisical_final
{
	...
	/// </summary>
	public static partial class ControllerReferencesThingBuilder
	{
		...
		public static bool CanAcceptSource(DslModeling::ModelElement candidate)
		{
			...
			else if (candidate is global::Company.CyberPhisical_final.Controller)
			{ 
				return true;
			}
			else
		...
		{
			if (candidate == null) return false;
			else if (candidate is global::Company.CyberPhisical_final.Things)
			{ 
				return true;
			}
			else
		...
		public static bool CanAcceptSourceAndTarget(DslModeling::ModelElement candidateSource, DslModeling::ModelElement candidateTarget)
		{
			...
			{
				if (candidateSource is global::Company.CyberPhisical_final.Controller)
				{
					if (candidateTarget is global::Company.CyberPhisical_final.Things)
					{
						global::Company.CyberPhisical_final.Controller sourceController = (global::Company.CyberPhisical_final.Controller)candidateSource;
						global::Company.CyberPhisical_final.Things targetThings = (global::Company.CyberPhisical_final.Things)candidateTarget;
						if(targetThings == null || sourceController == null || global::Company.CyberPhisical_final.ControllerReferencesThing.GetLinks(sourceController, targetThings).Count > 0) return false;
						return true;
					}
				}
		...
		public static DslModeling::ElementLink Connect(DslModeling::ModelElement source, DslModeling::ModelElement target)
		{
			...
			{
				if (source is global::Company.CyberPhisical_final.Controller)
				{
					if (target is global::Company.CyberPhisical_final.Things)
					{
						global::Company.CyberPhisical_final.Controller sourceAccepted = (global::Company.CyberPhisical_final.Controller)source;
						global::Company.CyberPhisical_final.Things targetAccepted = (global::Company.CyberPhisical_final.Things)target;
						DslModeling::ElementLink result = new global::Company.CyberPhisical_final.ControllerReferencesThing(sourceAccepted, targetAccepted);
	...
	internal partial class ConnectionTool1ConnectAction : DslDiagrams::ConnectAction
	{
		...
		private partial class ConnectionTool1ConnectionTypeBase : DslDiagrams::ConnectionType
		{
			...
			/// </summary>
			/// <remarks>
			/// This implementation delegates calls to the ConnectionBuilder ControllerReferencesThingBuilder.
			/// </remarks>
			public override bool CanCreateConnection(DslDiagrams::ShapeElement sourceShapeElement, DslDiagrams::ShapeElement targetShapeElement, ref string connectionWarning)
			{
				...
				{				
					if(targetShapeElement == null)
					{
						return ControllerReferencesThingBuilder.CanAcceptSource(sourceElement);
					}
					else
					{				
						return ControllerReferencesThingBuilder.CanAcceptSourceAndTarget(sourceElement, targetElement);
					}
				}
				else
				{
			...
			public override void CreateConnection(DslDiagrams::ShapeElement sourceShapeElement, DslDiagrams::ShapeElement targetShapeElement, DslDiagrams::PaintFeedbackArgs paintFeedbackArgs)
			{
				...
				if(targetElement == null) targetElement = targetShapeElement;
				ControllerReferencesThingBuilder.Connect(sourceElement, targetElement);
			}
		}
