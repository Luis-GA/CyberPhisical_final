...
namespace Company.CyberPhisical_final
{
	...
	/// </summary>
	internal partial class CyberPhisical_finalDocView : CyberPhisical_finalDocViewBase
	{
		/// <summary>
		/// Constructs a new CyberPhisical_finalDocView.
		/// </summary>
		public CyberPhisical_finalDocView(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider)
	...
	/// </summary>
	internal abstract class CyberPhisical_finalDocViewBase : DslShell::SingleDiagramDocView
	{
		/// <summary>
		/// Constructs a new CyberPhisical_finalDocView.
		/// </summary>
		protected CyberPhisical_finalDocViewBase(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider) : base(docData, serviceProvider)
		{
		}
		...
		protected override bool LoadView()
		{
			...
			CyberPhisical_finalDocDataBase docData = this.DocData as CyberPhisical_finalDocDataBase;
			global::System.Diagnostics.Debug.Assert(docData != null, "DocData for CyberPhisical_finalDocViewBase should be an CyberPhisical_finalDocDataBase!");
			DslModeling::Partition diagramPartition = docData.GetDiagramPartition();
			if (diagramPartition != null)
			{
				global::System.Collections.ObjectModel.ReadOnlyCollection<global::Company.CyberPhisical_final.CyberPhisical_finalDiagram> diagrams = docData.GetDiagramPartition().ElementDirectory.FindElements<global::Company.CyberPhisical_final.CyberPhisical_finalDiagram>();
				if (diagrams.Count > 0)
				{
		...
		protected override string DefaultToolboxTabName
		{
			get
			{
				return global::Company.CyberPhisical_final.CyberPhisical_finalToolboxHelper.DefaultToolboxTabName;
			}
		}
		...
		protected override int DefaultToolboxTabToolboxItemsCount
		{
			get
			{
				return global::Company.CyberPhisical_final.CyberPhisical_finalToolboxHelper.DefaultToolboxTabToolboxItemsCount;			
			}
		}
		...
		protected override global::System.ComponentModel.Design.CommandID ContextMenuId
		{
			get
			{
				return Constants.CyberPhisical_finalDiagramMenu;
			}
		}
			...
			if(global::Company.CyberPhisical_final.CyberPhisical_finalHelpKeywordHelper.Instance != null)
			{
				...
				if(selectedElement != null)
				{
					...
					if(presentationElement != null)
					{
						...
						if(selectedElement != null)
						{
							string modelElementKeyword = global::Company.CyberPhisical_final.CyberPhisical_finalHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
